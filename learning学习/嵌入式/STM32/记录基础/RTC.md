...
4. **写操作需等待前一次完成**
    ...
    - 可通过查询 `RTC_CR` 寄存器中的 `RTOFF` 状态位，判断RTC寄存器是否处于更新中。仅当 `RTOFF` 位为1时，才可写入RTC寄存器。 ![[Pasted image 20260727130040.png]]

![[Pasted image 20260727141103.png]]

![[Pasted image 20260727141108.png]]
## 初始化代码
```c
